...
const Step1Content = () => {
  ...
  <div className="text-center p-6 -mb-10">
    ...
    <div
      className={`card bg-white rounded-lg p-6 w-80 h-100 items-center justify-center shadow-[0px_0px_1px_0px] transform transition-transform duration-200 hover:scale-105 ${selectedCard === 'individual' ? 'border-1 border-primary' : ''}`}
    ...
    {/* Group Trip Card */}
    <div
      className={`card bg-white rounded-lg p-6 w-80 items-center justify-center shadow-[0px_0px_1px_0px] transform transition-transform duration-200 hover:scale-105 ${selectedCard === 'group' ? 'border-1 border-primary' : ''}`}
