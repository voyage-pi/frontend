...
const StepContent = ({
  ...
  switch (currentStep) {
    case 1:
      return <Step1 setDisableButton={setDisableButton} setCurrentStep={setCurrentStep} setShowLeaveButton={setShowLeaveButton} setIsGroup={setIsGroup} addedUsers={addedUsers} setAddedUsers={setAddedUsers} />
    case 2:
      return <Step2 setCurrentStep={setCurrentStep} />
    case 3:
      return <Step3 setDisableButton={setDisableButton} setCurrentStep={setCurrentStep} />
    case 4:
      return <Step4 setDisableButton={setDisableButton}/>
    case 5:
      return (
        <Step5Content
