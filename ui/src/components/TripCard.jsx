...
function TripCard({ image, days, people, destinations, name, date }) {
  return (
    <div className="card w-[14rem] h-[14rem] rounded-xl overflow-hidden shadow-sm relative">
      <img
        src={image}
        alt={name}
      ...
      <div className="card-body relative z-10 flex flex-col justify-between h-[14rem] p-2 pb-6">
